...
- seulement cas des caméras sans distorsion
...
- Expliquer qu'on peut récupérer des contraintes qui nous serviront pour la matrice intrinsèque
...
- Expliquer ce qu'est une matrice intrinsèque
- Expliquer ce qu'elle contient
...
- Grâce à ça on connait les paramètres de la caméra, alors qu'ils n'étaient pas donnés par le constructeur (je crois ?)
